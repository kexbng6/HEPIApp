...
class AttestationViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let task = URLSession.shared.dataTask(with: url, completionHandler: {data, _, error in
            ...
            DispatchQueue.main.async {
                ...
                self.attestationImageView.image = image
            }
        })
        task.resume()
    }
    
    @IBOutlet weak var attestationImageView: UIImageView!
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        if let image = info[UIImagePickerControllerOriginalImage] as? UIImage {
            attestationImageView.image = image
    ...
    func uploadImagePic(img1: UIImage){
        ...
        let filePath = "images/attestation.jpeg"
